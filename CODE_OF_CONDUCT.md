...
Maintainers are responsible for clarifying and enforcing these standards and will take appropriate and
fair corrective action in response to any behavior they deem inappropriate, threatening, offensive, or
harmful. Maintainers have the right to remove, edit, or reject comments, commits, code, issues, and
other contributions not aligned with this Code of Conduct.
...
maintainers via a **[private security advisory](https://github.com/panfot1409/gambling-winnings/security/advisories/new)**
or a direct message to the repository owner. All complaints will be reviewed and investigated
