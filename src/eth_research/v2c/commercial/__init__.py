...
The committed artifacts live under ``release/private/v2c/`` and reproduce byte-for-byte via
:func:`eth_research.v2c.commercial.evidence.check`. Nothing here is published; the programme is not
sell-ready and the repository is private.
"""
